...
const Main: React.FC = () => {
  ...
  return (
    <main className="bg-[rgba(226,238,238,1)] min-h-screen">
      <div
        className="fixed top-0 left-0 h-[4px] bg-yellow-500 transition-all duration-300"
      />
      
      <div className="first-block relative flex flex-col items-center min-h-[100vh] overflow-x-hidden overflow-y-visible">
        <img 
      ...
      <div className="flex mt-[2.81rem] overflow-x-auto">
        ...
        />
        <div className="flex flex-col gap-[1.31rem] max-w-full">
